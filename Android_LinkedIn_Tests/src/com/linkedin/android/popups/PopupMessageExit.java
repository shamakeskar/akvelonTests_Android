...
/**
 * Class for popup 'MessageExit'.
 * 
 * @author alexander.makarov
 * @created Oct 8, 2012 2:58:07 PM
 */
public class PopupMessageExit {
    // CONSTANTS ------------------------------------------------------------
    // Strings with texts "Yes/No" or other.
    public static final String POPUP_TEXT = "Are you sure you want to discard this message?";

    // Static ID of buttons in Yes/No popup.
    public static final int BUTTON1_ID = 16908313;
    public static final int BUTTON2_ID = 16908314;
    // Strings with texts "Yes/No" or other.
     ...
     */
    public static boolean isOnMessageExitPopup() {
