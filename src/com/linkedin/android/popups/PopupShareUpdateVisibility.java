...
public class PopupShareUpdateVisibility extends Popup {
    ...
    @TestAction(value = "go_to_share_visibility")
    public static void go_to_share_visibility(String email, String password) {
    ...
    @TestAction(value = "share_visibility_tap_back")
    ...
    @TestAction(value = "share_visibility_tap_connections_only")
    ...
    @TestAction(value = "share_visibility_tap_anyone")
    ...
    @TestAction(value = "share_visibility_tap_back_reset")
    public static void share_visibility_tap_back_reset() {
        share_visibility("share_visibility_tap_back_reset");
    }
    
    @TestAction(value = "share_visibility_tap_connections_only_reset")
