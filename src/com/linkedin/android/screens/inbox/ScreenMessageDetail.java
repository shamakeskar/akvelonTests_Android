...
public class ScreenMessageDetail extends BaseINScreen {
    ...
    private static final ViewIdName REPLY_ACTIONSHEET_BUTTON_ID_NAME = new ViewIdName("reply_button");
    ...
    private static final ViewIdName COMPOSE_ACTIONSHEET_BUTTON_ID_NAME = new ViewIdName("compose_button");
    ...
    public Popup openDeleteActionSheetFromMessageDetailScreen() {
        ...
        ViewUtils.tapOnView(delete, "'Delete' button");
    ...
    public static void go_to_inbox_message_detail() {
    ...
    public static void inbox_message_detail_tap_message_up() {
        ...
        new ScreenMessageDetail().openNextMessage();
    ...
    public static void inbox_message_detail_tap_message_down() {
        ...
        Assert.assertNotNull("Navigation bar title is not present", changingTextView);
        changingText = changingTextView.getText();
        new ScreenMessageDetail().openPreviousMessage();
        WaitActions.waitForTrueInFunction("New message is not loaded", new Callable<Boolean>() {
    ...
    public static void inbox_message_detail_tap_archive() {
        ...
        ViewUtils.tapOnView(arch, "'Archive' button");
    ...
    public static void inbox_message_detail_toggle_read_state() {
        ...
        WaitActions.waitForTrueInFunction("Text mark/unmark no changed", new Callable<Boolean>() {
            ...
            public Boolean call() throws Exception {
                TextView markButton = getMarkUnreadButton();
                if(markButton == null) return false;
    ...
    public static void inbox_message_detail_tap_delete() {
        new ScreenMessageDetail().openDeleteActionSheetFromMessageDetailScreen().tapOnButton(Popup.YES_BUTTON);
        new ScreenAllMessages();
    ...
    public static void inbox_message_detail_tap_respond_actionsheet() {
        ...
        ViewUtils.tapOnView(reply, "'Reply Actionsheet' button");
    ...
    public static void inbox_message_detail_respond_actionsheet_tap_reply_all() {
        ...
        new ScreenReplyMessage();
        TestUtils.delayAndCaptureScreenshot("inbox_message_detail_respond_actionsheet_tap_reply_all");
    }
    ...
    public static void inbox_message_detail_respond_actionsheet_tap_forward() {
        ...
        WaitActions.waitForTrueInFunction("'Forward screen' ia not present", new Callable<Boolean>() {
            
            @Override
            public Boolean call() throws Exception {
                TextView textView = (TextView)Id.getViewByViewIdName(NAVIGATION_BAR_TITLE_ID_NAME);
    ...
    public static void inbox_message_detail_compose_actionsheet_tap_new_message() {
       ...
       TestUtils.delayAndCaptureScreenshot("inbox_message_detail_compose_actionsheet_tap_new_message");
    }
    ...
    public static void inbox_message_detail_tap_compose_actionsheet() {
        ...
        ViewUtils.tapOnView(reply, "'Compose Actionsheet' button");
    ...
    public static void inbox_message_detail_compose_actionsheet_tap_new_invitation() {
        ...
        TestUtils.delayAndCaptureScreenshot("inbox_message_detail_compose_actionsheet_tap_new_invitation");
    }
    ...
    public static void inbox_message_detail_tap_url() {
        ...
        TextViewUtils.tapOnLinkInTextView(link, textLink);
        new ScreenBrowser();
    ...
    public static void inbox_message_detail_respond_actionsheet_tap_reply_reset() {
        HardwareActions.goBackOnPreviousActivity();
        TestUtils.delayAndCaptureScreenshot("inbox_message_detail_respond_actionsheet_tap_reply_reset");
    }

    public static void inbox_message_detail_respond_actionsheet_tap_reply_all_reset() {
        HardwareActions.goBackOnPreviousActivity();
        TestUtils.delayAndCaptureScreenshot("inbox_message_detail_respond_actionsheet_tap_reply_all_reset");
    }

    public static void inbox_message_detail_respond_actionsheet_tap_forward_reset() {
        HardwareActions.goBackOnPreviousActivity();
        TestUtils.delayAndCaptureScreenshot("inbox_message_detail_respond_actionsheet_tap_forward_reset");
   }

    public static void inbox_message_detail_compose_actionsheet_tap_new_message_reset() {
        HardwareActions.goBackOnPreviousActivity();
        TestUtils.delayAndCaptureScreenshot("inbox_message_detail_compose_actionsheet_tap_new_message_reset");
    }

    public static void inbox_message_detail_compose_actionsheet_tap_new_invitation_reset() {
        HardwareActions.goBackOnPreviousActivity();
        TestUtils.delayAndCaptureScreenshot("inbox_message_detail_compose_actionsheet_tap_new_invitation_reset");
    }
    ...
    public static void inbox_message_detail_tap_url_precondition() {
        LoginActions.openUpdatesScreenOnStart(StringData.test_email_large_connections, StringData.test_password_large_connections);
        new ScreenUpdates().openExposeScreen().openInboxScreen().openPopupCompose().tapOnNewMessageOnPopup();
        ScreenAddConnections screenAddConnections = new ScreenNewMessage().openAddConnectionsScreen();
        screenAddConnections.chooseConnection(StringData.test_name);
        screenAddConnections.tapOnDoneButton();
        ScreenNewMessage screenNewMessage = new ScreenNewMessage();
        screenNewMessage.typeMessage(StringData.test_blog_link);
        screenNewMessage.typeSubject(StringData.test_blog_link);
