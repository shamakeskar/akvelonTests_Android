...
public class ScreenUpdate extends BaseScreenSharedNewsDetails {
    ...
    // private static final ViewIdName LIKES_LAYOUT = new
    // ViewIdName("likes_layout");

    //private static final String VIEW_ALL_TEXT = "View all";
    //private static final String LIKE_THIS_TEXT = " like ";

    private static int HEADER_LABEL_INDEX = 5;
     ...
     *         screen.
     */
    public ScreenCommentsList openCommentsList() {
     ...
     */
    public ScreenLikesList openLikesList() {
