...
public class ScreenAddComment extends BaseScreen {
    ...
    public static void comment_compose(String screenName) {
        new ScreenUpdate().tapOnCommentButton();
        new ScreenAddComment();
        TestUtils.delayAndCaptureScreenshot(screenName);
    }
    
    public static void comment_compose() {
        comment_compose("comment_compose");
    }

    public static void comment_compose_tap_send() {
        new ScreenAddComment().tapOnSendButton();
        new ScreenUpdate();
    ...
    public static void comment_compose_tap_send_precondition(String text) {
        new ScreenAddComment().typeUpdateText(text);
        TestUtils.delayAndCaptureScreenshot("comment_compose_tap_send_precondition");
    }
}
