...
/**
 * Class for NUS Details that the user has updated his profile.
 * 
 * @author vasily.gancharov
 * @created Sep 21, 2012 18:14:31 PM
 */
public class ScreenUpdateProfile extends BaseScreenSharedNewsDetails {
    ...
    public void verify() {
        ...
        HardwareActions.takeCurrentActivityScreenshot("UpdatedProfile screen");
    }
