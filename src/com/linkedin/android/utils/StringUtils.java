...
public final class StringUtils {
    ...
    /**
     * Removes from string all not-digit characters and convert it to Integer.
     * 
     * @param string string with digits
     * @return number from specified string or <b>null</b> if string not contain digit characters.
     */
    public static Integer getNumberFromString(String string) {
        string = string.replaceAll("\\D+","");
        try {
            return Integer.parseInt(string);
        } catch (Exception e) {
            Logger.e("Cannot find digits in this string", e);
        }
        return null;
    }
}
